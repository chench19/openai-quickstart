...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--config', type=str, default='openai-translator\config.yaml', help='Configuration file with model and API settings.')
        self.parser.add_argument('--model_type', type=str, required=False, default='OpenAIModel', choices=['GLMModel', 'OpenAIModel'], help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')        
        ...
        self.parser.add_argument('--source_language', type=str, help='The target language')
        self.parser.add_argument('--target_language', type=str, help='The target language')
